...
"[project]/AdminCMS/src/pages/testimonials.jsx [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TestimonialsPage() {
    ...
    const fetchTestimonials = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$AdminCMS$2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["testimonialsAPI"].getAll();
            setTestimonials(response.data || []); // Safety check if data is null
        } catch (error) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$toastify__$5b$external$5d$__$28$react$2d$toastify$2c$__esm_import$29$__["toast"].error('Error fetching testimonials');
        }
    };
    const onSubmit = async (data)=>{
        try {
            if (editingId) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$AdminCMS$2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["testimonialsAPI"].update(editingId, data);
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$toastify__$5b$external$5d$__$28$react$2d$toastify$2c$__esm_import$29$__["toast"].success('Testimonial updated');
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$AdminCMS$2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["testimonialsAPI"].create(data);
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$toastify__$5b$external$5d$__$28$react$2d$toastify$2c$__esm_import$29$__["toast"].success('Testimonial created');
            }
            setModalOpen(false);
            reset();
            setEditingId(null);
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$toastify__$5b$external$5d$__$28$react$2d$toastify$2c$__esm_import$29$__["toast"].error('Error saving testimonial');
        }
    };
    ...
    const handleDelete = async (id)=>{
        if (window.confirm('Are you sure?')) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$AdminCMS$2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["testimonialsAPI"].delete(id);
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$toastify__$5b$external$5d$__$28$react$2d$toastify$2c$__esm_import$29$__["toast"].success('Testimonial deleted');
                fetchTestimonials();
            } catch (error) {
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$toastify__$5b$external$5d$__$28$react$2d$toastify$2c$__esm_import$29$__["toast"].error('Error deleting testimonial');
            }
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6397eaa8._.js.map